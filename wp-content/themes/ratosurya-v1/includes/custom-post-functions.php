...
function deshNews() {
    $labels = array(
        'name' => _x('Desh', 'rato_desh'),
        'singular_name' => _x('Desh', 'rato_desh'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'desh-news', 'rato-desh-news') ),
...
function samachar() {
    $labels = array(
        'name' => _x('Samachar', 'rato_samachar'),
        'singular_name' => _x('Samachar', 'rato_samachar'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'samachars', 'rato-samachar') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
...
function videoslist(){
    $labels = array(
        'name' => _x('Videos', 'rato_videos'),
        'singular_name' => _x('Videos', 'rato_videos'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'video', 'rato-videolist') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
...
function entertainment(){
    $labels = array(
        'name' => _x('Entertainment', 'rato_entertainments'),
        'singular_name' => _x('Entertainment', 'rato_entertainments'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'entertainment', 'rato-entertainment') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
...
function sports(){
    $labels = array(
        'name' => _x('Sports', 'rato_sports'),
        'singular_name' => _x('Sports', 'rato_sports'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'sports', 'rato-sports') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
...
function muncha(){
    $labels = array(
        'name' => _x('Muncha', 'rato_muncha'),
        'singular_name' => _x('Muncha', 'rato_muncha'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'muncha', 'rato-muncha') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
...
function special(){
    $labels = array(
        'name' => _x('Rato Surya Special', 'rato_special'),
        'singular_name' => _x('Rato Surya Special', 'rato_special'),
        ...
        'parent_item_colon' => '',
        'menu_name' => __('Rato Surya Special')
    );
    $args = array(
        'labels' => $labels,
        'public' => true,
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'special', 'rato-special') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
...
function itihas(){
    $labels = array(
        'name' => _x('Itihas', 'rato_itihas'),
        'singular_name' => _x('Itihas', 'rato_itihas'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'itihas', 'rato-itihas') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
...
function surakchya(){
    $labels = array(
        'name' => _x('Surakchya', 'rato_surakchya'),
        'singular_name' => _x('Surakchya', 'rato_surakchya'),
    ...
    $args = array(
        ...
        'show_in_menu' => true,
        'query_var' => true,
        'rewrite' => array( 'slug' => _x( 'surakchya', 'rato-itihas') ),
        'capability_type' => 'post',
        'has_archive' => true,
        'hierarchical' => false,
        'menu_position' => 5,
